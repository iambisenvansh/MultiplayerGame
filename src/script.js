const statements = {
    ...
    spicy: [
        ...
        "Flirt or Fib: I masturbated every day for a week.",
        "Flirt or Fib: I had sex again with my ex.",
        "Flirt or Fib: I had sex while high.",
        "Flirt or Fib: I broke a condom while putting it on.",
        "Flirt or Fib: I had sex in public.",
        "Flirt or Fib: I had sex when a friend entered the room.",
        "Flirt or Fib: I had sex with more than one person at the same time.",
        "Flirt or Fib: I forgot the name of my partner during sex."
...
/*
// Fetch the statements from the JSON file
    fetch('src/statements.json')
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const newStatementButton = document.getElementById('new-statement');
    const homeButton = document.getElementById('home-button');

    document.querySelectorAll('#category-screen button').forEach(button => {
        button.addEventListener('click', () => {
            const category = button.getAttribute('data-category');
            showRandomStatement(category);
            categoryScreen.classList.add('hidden');
            statementScreen.classList.remove('hidden');
        });
    });

    newStatementButton.addEventListener('click', () => {
        const currentCategory = statementScreen.getAttribute('data-category');
        showRandomStatement(currentCategory);
    });
    ...
    function showRandomStatement(category) {
        ...
        statementText.textContent = randomStatement;
        statementScreen.setAttribute('data-category', category);
    }
});